...
UNIT_OUTLINE = {
    "数学": ["七上·第1章 有理数", "七上·第2章 有理数的运算", "七上·第3章 实数",
            "七上·第4章 代数式", "七上·第5章 一元一次方程", "七上·第6章 图形的初步认识"],
    "物理": ["七上·测量与科学探究", "七上·物质的密度", "七上·物态变化",
            "七上·力与运动初步", "七上·速度与机械运动"],
    "化学": ["七上·物质的变化与分类", "七上·物质的构成", "七上·空气与氧气", "七上·水与溶液初步"],
    "生物": ["七上·观察生物", "七上·生物多样性", "七上·绿色植物", "七上·人体与生命"],
    "地理": ["七上·地球和地图", "七上·陆地和海洋", "七上·天气与气候",
            "七上·居民与聚落", "七上·发展与合作"],
    "道德与法治": ["七上·成长的节拍", "七上·友谊的天空", "七上·师长情谊", "七上·生命的思考"],
    "历史": ["七上·史前时期", "七上·早期国家", "七上·秦汉时期", "七上·三国两晋南北朝"],
    "语文": ["七上·古诗文", "七上·现代文阅读", "七上·名著导读", "七上·写作与语法"],
}
